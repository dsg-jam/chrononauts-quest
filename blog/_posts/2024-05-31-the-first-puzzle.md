...
{% include figure.html src="/assets/the-first-puzzle/c4dca62b7b5c.png" description="Screenshot of the Discord conversation that started it all." %}
...
{% include figure.html src="/assets/the-first-puzzle/59af47b7da12.jpg" description="My poor attempt of creating an interesting pattern." %}
...
{% include figure.html src="/assets/the-first-puzzle/5de6c1213c74.jpg" description="Kevin's wonderful origami." %}
...
{% include figure.html
    src="/assets/the-first-puzzle/e64fb54efc99.png"
...
%}
{% include figure.html
    src="/assets/the-first-puzzle/6b7253c49a55.png"
...
{% include figure.html src="/assets/the-first-puzzle/b6ca9d6dc9ae.png" description="All four corners rotated and aligned on the green line." %}
...
{% include figure.html src="/assets/the-first-puzzle/1c0bb27cf9ae.png" description="The projection of the square. You can tell how accurate it is based on the very noticeable gaps." %}
...
{% include figure.html src="/assets/the-first-puzzle/dc0696216611.png" description="Stretched QR code." %}
...
{% include figure.html src="/assets/the-first-puzzle/1d1e03d577b5.png" description="The QR code split into its parts and rotated into place." %}

At this point we weren't really convinced that this would work but at least I was still hopeful so we went ahead and
printed it.

<div class="figure-row">
{% include figure.html src="/assets/the-first-puzzle/32925d45eee6.jpg" description="My result." %}
{% include figure.html src="/assets/the-first-puzzle/48b728759eba.jpg" description="Kevin's result." %}
</div>
...
{% include figure.html src="/assets/the-first-puzzle/cf3a296fd544.png" description="Ready to print." %}
...
<div class="figure-row">
{% include figure.html src="/assets/the-first-puzzle/c33d5608fc36.jpg" description="Kevin's result." %}
{% include figure.html src="/assets/the-first-puzzle/88048431037b.jpg" description="My result." %}
</div>
...
<div class="figure-row">
{% include figure.html src="/assets/the-first-puzzle/0e68b58cd41c.jpg" description="Kevin's test print in black and white." %}
{% include figure.html src="/assets/the-first-puzzle/8d688a7a5a9a.jpg" description="My final test to make sure that it actually works." %}
</div>
